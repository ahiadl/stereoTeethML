...
#Loading the raw data from the files on FS
#verified
all_left_img, all_right_img, all_left_disp, test_left_img, test_right_img, test_left_disp = lt.dataloader(args.datapath)

#Data loader- fast way of loadind data (http://pytorch.org/docs/master/data.html)
#preprocessing the data D=float(d)/256
# TODO: verify the transformation
...
print('num of params: {}'.format(count_parameters(model)))
...
def train(imgL,imgR, disp_L):
        ...
        #DIMENSIONS: [batchSize,1,H,W], for default: [12,1,338,370]
        if args.cuda:
