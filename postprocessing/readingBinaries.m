  ...
  dispRaw = memmapfile('disparityRaw-leftAhiad.bin', 'Format', 'single').Data;
  dispRaw = reshape(dispRaw, [370, 338]);
  
  dispCor = memmapfile('disparityCorrect-leftAhiad.bin', 'Format', 'single').Data;
  dispCor = reshape(dispCor, [370 338]);
